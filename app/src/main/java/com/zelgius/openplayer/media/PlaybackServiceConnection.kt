...
package com.zelgius.openplayer.media
...
class MusicServiceConnection(context: Context, serviceComponent: ComponentName) {
    ...
    fun subscribe(parentId: String, callback: MediaBrowser.SubscriptionCallback) {
        mediaBrowser.subscribe(parentId, callback)
    }

    fun unsubscribe(parentId: String, callback: MediaBrowser.SubscriptionCallback) {
...
@Suppress("PropertyName")
val NOTHING_PLAYING: MediaMetadata = MediaMetadata.Builder()
